...
struct WasapiRealtimeWorkerStats {
  ...
  std::uint64_t capture_rate_clamped_cycles = 0;
  std::uint64_t current_consecutive_capture_rate_clamped_cycles = 0;
  std::uint64_t maximum_consecutive_capture_rate_clamped_cycles = 0;
  std::uint64_t current_consecutive_capture_rate_clamped_frames = 0;
...
class WindowsWasapiRealtimeWorker {
 ...
 private:
  ...
  std::atomic_uint64_t duplex_event_wait_timeout_cycles_ = 0;
  ...
  std::atomic_uint64_t capture_fifo_fill_frames_ = 0;
  std::atomic_uint64_t render_fifo_fill_frames_ = 0;
  std::atomic_uint64_t capture_fifo_overflow_cycles_ = 0;
  std::atomic_uint64_t capture_fifo_overflow_frames_ = 0;
  std::atomic_uint64_t render_fifo_overflow_cycles_ = 0;
  std::atomic_uint64_t render_fifo_overflow_frames_ = 0;
  std::atomic_uint64_t render_fifo_underflow_cycles_ = 0;
  std::atomic_uint64_t render_fifo_underflow_frames_ = 0;
  ...
  std::atomic_bool capture_rate_correction_clamped_ = false;
  std::atomic_bool capture_rate_adapter_recovering_ = false;
  std::atomic_uint64_t capture_rate_adapter_reset_cycles_ = 0;
  std::atomic_uint64_t capture_rate_clamped_cycles_ = 0;
  std::atomic_uint64_t current_consecutive_capture_rate_clamped_cycles_ = 0;
  std::atomic_uint64_t maximum_consecutive_capture_rate_clamped_cycles_ = 0;
  std::atomic_uint64_t current_consecutive_capture_rate_clamped_frames_ = 0;
  std::atomic_uint64_t maximum_consecutive_capture_rate_clamped_frames_ = 0;
  ...
  std::atomic_uint64_t render_recovery_silence_episodes_ = 0;
