...
int main() {
...

  {
    ...
    if (const auto failure =
            expect(summary_line ==
                       ...
                       "sample_conversion_import_failures=0 "
                       "sample_conversion_export_failures=0 "
...

  {
    ...
    diagnostics.sample_conversion_import_failures = 5;
    diagnostics.sample_conversion_export_failures = 6;
    ...
    if (const auto failure =
            expect(summary.capture_fifo_fill_frames == 144 &&
                       ...
                       summary.sample_conversion_import_failures == 5 &&
                       summary.sample_conversion_export_failures == 6 &&
    ...
    if (const auto failure =
            expect(summary_line.find("capture_fifo_fill_frames=144") !=
                       ...
                       summary_line.find("render_fifo_underflow_frames=24") !=
                           std::string::npos &&
                       summary_line.find(
                           "sample_conversion_import_failures=5") !=
                           std::string::npos &&
                       summary_line.find(
                           "sample_conversion_export_failures=6") !=
                           std::string::npos &&
...

  {
    ...
    if (const auto failure =
            expect_summary(summary,
                           ...
                           "Expected import conversion failure summary")) {
      return failure;
    }
  }

  {
    ...
    if (const auto failure =
            expect_summary(summary,
                           ...
                           "Expected export conversion failure summary")) {
      return failure;
    }
  }

  {
    ...
    if (const auto failure =
            expect_summary(summary,
                           ...
                           "Expected combined conversion failure summary")) {
      return failure;
    }
  }
