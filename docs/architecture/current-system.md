...
commands. Control wire version 11 carries installed/running/runtime graph-version
...
configuration. The Qt Quick GUI now binds to control wire v11 from a separate process.
