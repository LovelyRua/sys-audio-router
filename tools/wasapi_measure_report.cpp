...
void print_wasapi_runtime_summary(
  ...
  out << "  Capture FIFO fill frames: " << summary.capture_fifo_fill_frames << '\n';
  ...
  out << "  Render FIFO overflow frames: "
      << summary.render_fifo_overflow_frames << '\n';
  out << "  Render FIFO underflow cycles: "
...
void print_wasapi_worker_stats(
  ...
  out << "wasapi_worker_stats"
      ...
      << " capture_resampler_input_frames="
      << stats.capture_resampler_input_frames
      << " capture_resampler_output_frames="
  ...
  out << "  Capture resampler input frames: "
      << stats.capture_resampler_input_frames << '\n';
  out << "  Capture resampler output frames: "
      << stats.capture_resampler_output_frames << '\n';
...
void print_wasapi_engine_diagnostics(
  ...
  out << "engine_diagnostics"
      ...
      << " capture_fifo_fill_frames=" << diagnostics.capture_fifo_fill_frames
  ...
  out << "  Capture FIFO fill frames: " << diagnostics.capture_fifo_fill_frames
      << '\n';
  out << "  Render FIFO fill frames: " << diagnostics.render_fifo_fill_frames
      << '\n';
  out << "  Capture FIFO overflow cycles: "
      << diagnostics.capture_fifo_overflow_cycles << '\n';
  out << "  Capture FIFO overflow frames: "
