    ...
    try {
      ...
      if ($pushedDelta -lt $minimumProducerBlocks -or
        ...
        throw ((("REAPER ASIO duration acceptance failed: duration={0} " +
            ...
            "processed_delta={6}/{5} dropped_delta={7} " +
            "producer_underflow_delta={8} producer_overflow_delta={9} " +
            "xrun_delta={10} clipped_delta={11} non_finite_delta={12} " +
            "callback_peak_us={13}/{14}. Final diagnostics: {15}") -f
